...
base_path8 = r"C:\temp\Cmodel_v34_10mm_load\inputs_gh_f1"  # cube
...
for (i, base_path) in enumerate(base_paths):
    ...
    for (j, mag) in enumerate(reversed(magnitudes)):
        ...
        if i == 0:
            ...
            wait_time = 900
            # if mag in [77381, 80559, 85034, 86081, 127639, 130208, 137255]:
            #     continue
        elif i == 6:
            ...
            wait_time = 600
            # if mag not in [340136, 282187, 250627, 197664, 137255]:
            #     continue
        elif i == 9:  ####
            job_name = f"Job-HT_Cmodel_v33_thinwall_0-22mm_{mag}_4-5-cond15_Ti64"  ####
            wait_time = 600
            # if mag not in [92971, 85034, 77277, 71429, 59524, 52693, 51760, 130208, 129400, 115035, 127639, 123810, 123153]:
            #     continue
        elif i == 10:  ####
            ...
            wait_time = 900
            # if mag not in [92971,340136,282187,250627,197664,137255,130208,129400,127639,123810,115035,123153]:
            #     continue
