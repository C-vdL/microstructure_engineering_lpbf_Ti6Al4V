...
mdb.models['Model-1'].Part(dimensionality=THREE_D, name='Part-substrate', type=
    DEFORMABLE_BODY)
mdb.models['Model-1'].parts['Part-substrate'].BaseSolidExtrude(depth=1, sketch=
    mdb.models['Model-1'].sketches['__profile__'])
del mdb.models['Model-1'].sketches['__profile__']
mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=200.0)
...
mdb.models['Model-1'].Part(dimensionality=THREE_D, name='Part-lpbf', type=
    DEFORMABLE_BODY)
mdb.models['Model-1'].parts['Part-lpbf'].BaseSolidExtrude(depth=1, sketch=
    mdb.models['Model-1'].sketches['__profile__'])
del mdb.models['Model-1'].sketches['__profile__']
...
mdb.models['Model-HT'].rootAssembly.Set(cells=
    ...
    mdb.models['Model-HT'].rootAssembly.instances['Part-lpbf-1'].cells.getSequenceFromMask(
    mask=('[#1 ]', ), ), name='Set-all')
mdb.models['Model-HT'].eventSeriesDatas['Event series-laser_layer'].setValues(
    createStepName='Initial', data=[[11.0, 4.5, 5.0, 0.03, 450000.0], [11.001,
    5.5, 5.0, 0.03, 0.0], [23.0, 4.5, 5.0, 0.06, 450000.0], [23.001, 5.5, 5.0,
    0.06, 0.0], [35.0, 4.5, 5.0, 0.09, 450000.0], [35.001, 5.5, 5.0, 0.09,
    0.0], [47.0, 4.5, 5.0, 0.12, 450000.0], [47.001, 5.5, 5.0, 0.12, 0.0],
    [59.0, 4.5, 5.0, 0.15, 450000.0], [59.001, 5.5, 5.0, 0.15, 0.0], [71.0,
    4.5, 5.0, 0.18, 450000.0], [71.001, 5.5, 5.0, 0.18, 0.0], [83.0, 4.5, 5.0,
    0.21, 450000.0], [83.001, 5.5, 5.0, 0.21, 0.0], [95.0, 4.5, 5.0, 0.24,
    450000.0], [95.001, 5.5, 5.0, 0.24, 0.0], [107.0, 4.5, 5.0, 0.27,
    450000.0], [107.001, 5.5, 5.0, 0.27, 0.0], [119.0, 4.5, 5.0, 0.3,
    450000.0], [119.001, 5.5, 5.0, 0.3, 0.0]], timeSpan=STEP_TIME)
mdb.models['Model-HT'].TableCollection(name='ABQ_AM.Moving Heat Source')
mdb.models['Model-HT'].tableCollections['ABQ_AM.Moving Heat Source'].ParameterTable(
    name='ABQ_AM_MovingHeatSource')
mdb.models['Model-HT'].tableCollections['ABQ_AM.Moving Heat Source'].parameterTables['ABQ_AM_MovingHeatSource'].Column(
...
del mdb.models['Model-HT'].loads['Load-1']
